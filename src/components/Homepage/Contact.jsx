...
const Contact = () => {
  return (
    <div>
      <section class="max-h-screen bg-white">
          ...
          <div class="lg:flex lg:items-center lg:-mx-10">
            <div class="lg:w-1/2 lg:mx-10">
              ...
              <form class="mt-12">
                <div class="-mx-2 md:items-center md:flex">
                  <div class="flex-1 px-2">
                    ...
                    <input
                      ...
                      class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-400 rounded-md dark:placeholder-gray-300 dark:text-gray-300  focus:border-neutral-200 focus:ring-neutral-400 focus:outline-none focus:ring focus:ring-opacity-40"
                    />
                  </div>
                ...
                <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-black rounded-sm hover:bg-neutral-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                  get in touch
                </button>
              </form>
            </div>
              ...
              <div class="mt-6 space-y-5 md:mt-8">
                ...
                <p class="flex items-start -mx-2">
                  <svg
                    ...
                    class="w-6 h-6 mx-2  dark:text-blue-400"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
